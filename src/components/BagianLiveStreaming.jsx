...
function ThumbnailVideo({ thumbnail, linkVideo }) {
  return (
    <div style={{ position: 'relative', width: '100%', borderRadius: '16px', overflow: 'hidden', cursor: 'pointer' }}>
    ...
    <section style={{ backgroundColor: '#faf6f0', minHeight: '100vh', position: 'relative', overflow: 'hidden', padding: '52px 20px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ marginBottom: '52px' }}>
          ...
          <ThumbnailVideo thumbnail={dataLiveStreaming.thumbnail} linkVideo={dataLiveStreaming.linkVideo} />
        </div>
        ...
        <div>
          ...
          <ThumbnailVideo thumbnail={dataOurFootage.thumbnail} linkVideo={dataOurFootage.linkVideo} />
        </div>
